...
#np.savetxt('part2_gpts.txt', gpts_rewards_per_experiment)
#np.savetxt('part2_gpucb.txt', gpucb_rewards_per_experiment)

#gpts_rewards_per_experiment = np.loadtxt('part2_gpts.txt')
#gpucb_rewards_per_experiment = np.loadtxt('part2_gpucb.txt')
